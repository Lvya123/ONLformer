...
path_chk_rest = model_dir
best_epoch_psnr = {'epoch': 0, 'psnr': 0}
for epoch in range(2380, 2400):
    path_chk_rest = os.path.join(path_chk_rest, f'model_epoch_{epoch}.pth')
    ...
    if avg_psnr > best_epoch_psnr['psnr']:
        best_epoch_psnr['epoch'] = epoch
        best_epoch_psnr['psnr'] = avg_psnr

    print(f"best epoch: {best_epoch_psnr['epoch']}, best psnr: {best_epoch_psnr['psnr']}")
